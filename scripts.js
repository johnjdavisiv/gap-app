...
function updateResult(){    
    ...
    if (calc_mode == 'pace'){
        ...
        let v_guess = target_W_kg / total_Cr; // Initial guess using flat speed economy
        for (let i = 0; i < 10; i++) {
            let Cr_at_guess = lookupSpeed(v_guess, 'energy_j_kg_m');
            let total_Cr_correct = Cr_at_guess + delta_Cr;
            v_guess = target_W_kg / total_Cr_correct;
        }
